...
public class HumidityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weekly == null && monthly == null && yearly == null && daily.equals("Daily")) {
            ...
            actionBar.setTitle("Daily Humidity readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Weekly Humidity readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Monthly Humidity readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Yearly Humidity readings");
        ...
        final StringRequest stringRequest = new StringRequest(Request.Method.GET, url, response -> {
            try {
                ...
                for (int i = 0; i< jsonArray.length();i++ ){
                    ...
                    if(hum.equals(" ") || hum.equals("null")){
                        hum="0";
                    }
                    periodValues.add(hum);
                ...
                viewGraph.setOnClickListener((v)->{
                    ...
                    intent.putStringArrayListExtra("humValues",periodValues);
