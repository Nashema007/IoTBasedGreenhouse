...
public class MoistureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weekly == null && monthly == null && yearly == null && daily.equals("Daily")) {
            ...
            actionBar.setTitle("Daily Moisture readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Weekly Moisture readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Monthly Moisture readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Yearly Moisture readings");
        ...
        final StringRequest stringRequest = new StringRequest(Request.Method.GET, url, response -> {
            try {
                ...
                for (int i = 0; i< jsonArray.length();i++ ){
                    ...
                    String moisture = object.getString("moisture");
                    if(moisture.equals(" ") || moisture.equals("null")){
                        moisture="0";
                    }
                    periodValues.add(moisture);
                ...
                viewGraph.setOnClickListener((v)->{
                    ...
                    intent.putStringArrayListExtra("moistValues",periodValues);
