...
public class TemperatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weekly == null && monthly == null && yearly == null && daily.equals("Daily")) {
            ...
            actionBar.setTitle("Daily Temperature readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Weekly Temperature readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Monthly Temperature readings");
            ...
            assert actionBar != null;
            actionBar.setTitle("Yearly Temperature readings");
            ...
            try {
                ...
                setTitle(period,periodValues);
                    ...
                    viewGraph.setOnClickListener((v)->{
                        ...
                        intent.putStringArrayListExtra("tempValues",periodValues);
